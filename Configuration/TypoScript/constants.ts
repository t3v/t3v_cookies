...
plugin {
  tx_t3vcookies {
    gridElements {
      noteGridElement {
        # cat=plugin/tx_t3vcookies/gridElements/noteGridElement; type=string; label=The grid element's container.
        container = default

        # cat=plugin/tx_t3vcookies/gridElements/noteGridElement; type=boolean; label=Enables the close control.
        closeControl = 1
      }
    }
