<?php
namespace T3v\T3vCookies\Tests\Functional;
 ...
 *
 * @package T3v\T3vCookies\Tests\Functional
 */
class RenderingTest extends FunctionalTestCase {
  ...
  public function templateIsRendered() {
    ...
    $expectedDom->loadHTML('<h1>T3v Cookies</h1>');
  ...
  protected function setUp() {
    ...
    $this->setUpFrontendRootPage(1, ['EXT:t3v_cookies/Tests/Functional/Fixtures/Frontend/Basic.typoscript']);
  }
